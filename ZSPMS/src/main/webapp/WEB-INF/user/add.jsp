 ...
 */	
	...
	function chkRePwd(){
		...
		if(repwd==password){//正确
			...
			$("#resultRepwd").html("密码必须包含数字和字母，并且不能低于六位");
...
<img src="${pageContext.request.contextPath}/images/logo4.png"/><!-- 绝对路径 -->
<img src="../imgaes/logo4.png" /><!-- 相对路径../表示上一级 -->
...
<!-- onsubmit="return chkAll()"ajax的第二种提交方法 -->	
